...
public class MainActivity extends ActionBarActivity {
    ...
    private void makeQuestions() {
        ...
        Question q2 =new Question(R.drawable.quiz01,"一番大きな都道府県は？","北海道","長野","岡山");
        question_list.add(q2);
        Question q3 =new Question(R.drawable.quiz02,"一番小さな都道府県は？","香川","東京","大阪");
        question_list.add(q3);
        Question q4 =new Question(R.drawable.quiz03,"海に面していない都道府県は？","埼玉","京都","佐賀");
        question_list.add(q4);
        Question q5 =new Question(R.drawable.quiz04,"最南端の島がある都道府県は？","東京","沖縄","鹿児島");
